...
export class SuppliesComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private categoryService: CategoryService, private supplyService: SuppliesService, private compositionService: CompositionService) { }
